 ...
 */
public class Paste extends Product implements ToBeAProduct{
    private String name;
    ...
    public Paste(String n, int c, double p, boolean gm, int protein, int fats, Text t, Text bt, Image image){
        this.name = n;
        this.calories = c;
        this.price = p;
