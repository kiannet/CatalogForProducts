 ...
 */
public class Sweet extends Product implements ToBeAProduct{
    private String name;
    ...
    public Sweet(String n, int c, double p, boolean gm, int protein, int fats, Text t, Text bt, Image image){
        this.name = n;
        this.calories = c;
        this.price = p;
